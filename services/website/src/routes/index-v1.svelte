<script lang="ts">
  ...
  import Byoc from "$lib/components/byoc/v1/index.svelte";
        ...
        <div class="mt-20">
          ...
          <div class="mt-6 sm:max-w-xl">
            ...
            <p class="mt-6 text-xl">
              The only comprehensive full-stack learning environment, from HTML
              to databases and anything in-between.
            </p>
          </div>
          <form
      ...
      >
        ...
        <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
          <div>
            ...
            <p class="mt-6 max-w-3xl text-lg leading-7">
              The best part: You, and you alone decide which modules you want to
              learn about and which technology stack interests you most.
            </p>
            <p class="mt-6 max-w-3xl text-lg leading-7">
          ...
          <div class="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div class="mt-6 space-y-6">
              ...
              <p class="text-lg leading-7">
                ...
                educate full-stack web developers. Each lesson is
              ...
              <ul>
                ...
                <li>
                  <Link
                    ...
                    >🧑‍🎓 Cloud Native Development with Tailwind, Google Cloud
                    and Firebase</Link
                  >
                </li>
                <li>
